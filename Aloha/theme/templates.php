...
<head>
  ...
  <link href="css/responsive.css" rel="stylesheet">
    ...
    <style>
    /* Custom CSS styles for header and footer */
    header {
    ...
    .navbar-nav > li.dropdown:hover > ul > li > a,
    .navbar-nav > li.dropdown:focus > ul > li > a {
        color: #3498db !important;
        background-color: transparent !important;
    }
    ...
    .navbar-nav > li > a[href*="cart"] {
        background-color: #F0F0E9 !important; /* Set the background color for Cart button */
        border-radius: 5px !important;
    }
    .navbar-nav > li > a[data-target="#smyModal"] {
        background-color: #F0F0E9 !important; /* Set the background color for Login button */
        border-radius: 5px !important;
    }

    
  .navbar-nav > li > a[href*="profile"],
  .navbar-nav > li > a[href*="logout"] {
      background-color: #F0F0E9 !important; /* Set the background color for Cart, Account, and Logout buttons */
      border-radius: 5px !important;
  }

    .navbar-nav > li > a[href*="cart"]:hover,
.navbar-nav > li > a[data-target="#smyModal"]:hover,
.navbar-nav > li > a[href*="profile"]:hover,
.navbar-nav > li > a[href*="logout"]:hover,
.navbar-nav > li > a[data-target="#smyModal"]:focus,
.navbar-nav > li > a[href*="cart"]:focus,
.navbar-nav > li > a[href*="profile"]:focus,
.navbar-nav > li > a[href*="logout"]:focus {
    background-color: #2c3e50 !important; /* Set the hover/focus color for Cart, Account, and Logout buttons */
}
...
<body style="background-color:lightblue" onload="totalprice()" >

  <header id="header"><!--header-->
    <div class="header_top" style="background-color:lightblue"><!--header_top-->
      <div class="container">
        <div class="row">
          <div class="col-sm-6">
            <div class="contactinfo">
              <ul class="nav nav-pills">
                <li><a href="#"><i class="fa fa-phone"></i> +961 79 124 439</a></li>
                <li><a href="#"><i class="fa fa-envelope"></i> Aloha@gmail.com</a></li>
              </ul>
            </div>
          </div>
          <div class="col-sm-6">
          ...
          <div class="col-sm-9">
            ...
            <div class="mainmenu pull-left">
              <ul class="nav navbar-nav collapse navbar-collapse">
                <li><a href="<?php echo web_root;?>" class="active" style="color: lightblue;">Home</a></li>
        ...
        <div class="row">
          <div class="col-sm-2">
            <div class="companyinfo">
              <h2> <img src="images/home/logo1.png" alt="" style=" max-height: 80px;" />
              </h2>
          ...
          <div class="col-sm-3">
            <div class="address">
              ...
              <p>beirut,lebanon,lebanese american univercity</p>
            </div>
          </div>
        </div>
      </div>
...
<script type="text/javascript" language="javascript" src="<?php echo web_root; ?>js/aloha.js"></script> 
 <script type="text/javascript">
